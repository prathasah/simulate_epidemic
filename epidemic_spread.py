...
if __name__ == "__main__":
    ...
    #try:
    print " Starting a epidemic simulation on a simple poisson modular random graph with modularity 0.6"
    print "The graph has 1000 nodes, 10 modules and has has average network degree of 5"
    print " Starting the epidemic simulation"
    #G=gr.generate_mod_networks("poisson", 0.6, 10000, 10, 5)
